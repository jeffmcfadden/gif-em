...
ActiveRecord::Schema.define(version: 20160714171124) do
  ...
  create_table "taggings", force: :cascade do |t|
    ...
    t.float    "confidence",                default: 100.0
  end

  add_index "taggings", ["confidence"], name: "index_taggings_on_confidence", using: :btree
  add_index "taggings", ["tag_id", "confidence"], name: "index_taggings_on_tag_id_and_confidence", using: :btree
